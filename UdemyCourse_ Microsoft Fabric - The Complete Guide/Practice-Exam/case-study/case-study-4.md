...
- The new lakehouses must follow a **medallion architecture** by using the following three layers: **bronze**, **silver**, and **g![1769929072470](image/case-study-4/1769929072470.png)**.
...
- I**n the POS1 product data, ProductID values are unique.**
